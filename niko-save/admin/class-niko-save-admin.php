...
class Niko_Save_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/niko-save-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/niko-save-admin.js', array( 'jquery' ), $this->version, false );
...
public function register_settings_page() {
	...
	add_submenu_page(
		...
		__( 'Niko Save', 'niko-save' ),      // page title
		__( 'Niko Save', 'niko-save' ),      // menu title
...
public function display_settings_page() {
	...
	require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/niko-save-admin-display.php';
...
public function register_settings() {
	...
	add_settings_field(
		'post-types',
		__( 'Post Types', 'niko-save' ),
		array( $this, 'sandbox_add_settings_field_multiple_checkbox' ),
		$this->plugin_name . '-settings',
		$this->plugin_name . '-settings-section',
		array(
			'label_for' => 'post-types',
			'description' => __( 'Save button will be added only to the checked post types.', 'niko-save' )
		)
	);
	add_settings_field(
		'toggle-content-override',
		__( 'Append Button', 'niko-save' ),
		array( $this, 'sandbox_add_settings_field_single_checkbox' ),
		$this->plugin_name . '-settings',
		$this->plugin_name . '-settings-section',
		array(
			'label_for' => 'toggle-content-override',
			'description' => __( 'If checked, it will append save button to the content.', 'niko-save' )
		)
	);
	add_settings_field(
		'toggle-status-override',
		__( 'Membership', 'niko-save' ),
		array( $this, 'sandbox_add_settings_field_single_checkbox' ),
		$this->plugin_name . '-settings',
		$this->plugin_name . '-settings-section',
		array(
			'label_for' => 'toggle-status-override',
			'description' => __( 'If checked, this feature will be available only to logged in users. ', 'niko-save' )
		)
	);
	add_settings_field(
		'toggle-css-override',
		__( 'Our Styles', 'niko-save' ),
		array( $this, 'sandbox_add_settings_field_single_checkbox' ),
		$this->plugin_name . '-settings',
		$this->plugin_name . '-settings-section',
		array(
			'label_for' => 'toggle-css-override',
			'description' => __( 'If checked, our style will be used.', 'niko-save' )
		)
	);
	add_settings_field(
		'text-save',
		__( 'Save Item', 'niko-save' ),
		array( $this, 'sandbox_add_settings_field_input_text' ),
		$this->plugin_name . '-settings',
		$this->plugin_name . '-settings-section',
		array(
			'label_for' => 'text-save',
			'default'   => __( 'Save Item', 'niko-save' )
		)
	);
	add_settings_field(
		'text-unsave',
		__( 'Unsave Item', 'niko-save' ),
		array( $this, 'sandbox_add_settings_field_input_text' ),
		$this->plugin_name . '-settings',
		$this->plugin_name . '-settings-section',
		array(
			'label_for' => 'text-unsave',
			'default'   => __( 'Unsave Item','niko-save' )
		)
	);
	add_settings_field(
		'text-saved',
		__( 'Saved. See saved items.', 'niko-save' ),
		array( $this, 'sandbox_add_settings_field_input_text' ),
		$this->plugin_name . '-settings',
		$this->plugin_name . '-settings-section',
		array(
			'label_for' => 'text-saved',
			'default'   => __( 'Saved. See saved items.', 'niko-save' )
		)
	);
	add_settings_field(
		'text-no-saved',
		__( 'You don\'t have any saved items.', 'niko-save' ),
		array( $this, 'sandbox_add_settings_field_input_text' ),
		$this->plugin_name . '-settings',
		$this->plugin_name . '-settings-section',
		array(
			'label_for' => 'text-no-saved',
			'default'   => __( 'You don\'t have any saved items.', 'niko-save' )
		)
	);
